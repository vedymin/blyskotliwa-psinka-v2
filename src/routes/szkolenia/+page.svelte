...
<div class='mx-20 text-center xl:text-left'>
	...
	<p class='pb-2'>
		...
		zewnętrznym. W razie potrzeby zapewniamy opiekę weterynaryjną, żeby zadbać o zdrowie i bezpieczeństwo psów
	...
	<ul class='list-disc ml-6 text-left'>
		...
		<li>Smycz, obroża lub szelki</li>
		<li>Legowisko lub kocyk</li>
		<li>Mile widziane smakołyki, gryzaki, zabawki</li>
	</ul>
</div>
